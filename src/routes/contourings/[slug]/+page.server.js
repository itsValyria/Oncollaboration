...
export async function load({params}) {
  const contouringURL = `${baseURL}avl_contourings?fields=image_scan,title,id,user_id.profile_picture.id,user_id.profile_picture.title,user_id.fullname,user_id.entitle,used_literature.directus_files_id.id,used_literature.directus_files_id.filesize,categories.avl_categories_id.name&filter[slug][_eq]=${params.slug}`
